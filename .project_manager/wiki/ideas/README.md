...
```bash
python3 .project_manager/tools/board.py idea list [--status open|promoted|killed]
python3 .project_manager/tools/board.py idea new "<title>" [--tag a,b]
python3 .project_manager/tools/board.py idea promote NNNN   # open/ → promoted/
python3 .project_manager/tools/board.py idea kill NNNN      # open/ → killed/
```
