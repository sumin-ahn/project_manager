...
대조한다. 역할 밖 변경이 있으면 회수 범위를 넓히지 말고 loud하게 보고한다. 하네스가 단일 경로
쓰기를 강제하지 못한다는 warning은 이 감사를 생략하거나 선택 target을 바꾸는 근거가 아니다.
