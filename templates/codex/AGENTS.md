...
> 세션 진입점의 **harness-neutral 공통 코어**. 프로젝트 정체성·엔진 호출·완료 기록·결정 권한·안전 가드를 공유하며, 하네스별 실행·위임 지침과 함께 적용한다.
